...
async function createLibraryDatabase() {
  ...
  // await pool.query(`insert into friendsTable values ('1' , '3', 'neeraj', 'vashistha', 'profileNeeraj', 'ankit', 'sharma', 'vivekprofile', '1' )`);
  // await pool.query(`insert into friendsTable values ('2' , '4', 'vivek', 'vashistha', 'profileNeeraj', 'nikhil', 'sharma', 'vivekprofile', '0' )`);
  // await pool.query(`insert into friendsTable values ('1' , '5', 'neeraj', 'vashistha', 'profileNeeraj', 'lala', 'sharma', 'vivekprofile', '2' )`);
  // await pool.query(`insert into friendsTable values ('5' , '2', 'lala', 'vashistha', 'profileNeeraj', 'mohit', 'sharma', 'vivekprofile', '1' )`);
  // await pool.query(`insert into friendsTable values ('4' , '3', 'nikhil', 'vashistha', 'profileNeeraj', 'ankit', 'sharma', 'vivekprofile', '0' )`);
  // await pool.query(`insert into friendsTable values ('1' , '7', 'neeraj', 'vashistha', 'profileNeeraj', 'pandey', 'sharma', 'vivekprofile', '1' )`);
